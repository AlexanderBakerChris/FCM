...
OuterBoundaryFactory = BoundaryRecoveryFactory(PlateOuter,BoundingBox,7,0);

InnerBoundaryFactory = BoundaryRecoveryFactory(PlateInner,BoundingBox,7,0);
...
Boundary = ...
    OuterBoundaryFactory.getBoundaryAndNormals();
...
Boundary = ...
    InnerBoundaryFactory.getBoundaryAndNormals();
