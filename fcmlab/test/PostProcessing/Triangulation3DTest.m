...
classdef Triangulation3DTest < AbsPostProcessorTest3D
    
    methods
        %% Constructor
        function obj = Triangulation3DTest(name)
        ...
        function testTriangulation(obj)
             ...
             postProcessingMesh = obj.ppSurfaceMeshFactory.createPostProcessingMesh( obj.FeMesh );
...
%             
%             figure();
%             patch('Faces',tris,'Vertices',xyz,'FaceColor','b');
