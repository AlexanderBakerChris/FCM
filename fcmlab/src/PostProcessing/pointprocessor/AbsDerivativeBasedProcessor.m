...
classdef AbsDerivativeBasedProcessor < AbsResultPointProcessor
    
    methods( Access = public )
        
        function obj = AbsDerivativeBasedProcessor( solutionNumbers, label ,domainIndex )
    ...
    methods( Access = protected )
        ...
        function setup( obj, resultPoint )
            ...
            obj.C = material(obj.domainIndex).getMaterialMatrix();
