...
classdef VisualPostProcessingFactory3D < AbsVisualPostProcessingFactory
    
 methods( Access = public )
        
        function obj = VisualPostProcessingFactory3D( FeMesh, gridSizes )
            obj.FeMesh = FeMesh;           
    ...
    methods
        ...
        function postProcessingMeshFactory = createPostProcessingMeshFactory( obj )
            ...
            postProcessingMeshFactory =  Triangulation3D( obj.gridSizes );
