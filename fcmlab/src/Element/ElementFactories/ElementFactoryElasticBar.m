...
% Element Factory Elastic Bar class

classdef ElementFactoryElasticBar < AbsElementFactory
    
    methods
        %% constructor
        function obj = ElementFactoryElasticBar(Material,integrationOrder)
        ...
        function Element = createElement(obj,Nodes,Edges,~,~,...
            ...
            Element = ElasticBar(Nodes,Edges,obj.material,obj.integrator,...
