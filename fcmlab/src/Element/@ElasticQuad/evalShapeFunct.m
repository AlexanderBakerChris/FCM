...
function N = evalShapeFunct(obj,Coord)
    ...
    NodalModes = obj.evalNodalModes(OneMinusR,OnePlusR,OneMinusS,OnePlusS);

    EdgeModes = obj.evalEdgeModes(OneMinusR,OnePlusR,OneMinusS,OnePlusS,PhiR,PhiS,DofsLocalDirection);
    
    FaceModes = obj.evalFaceModes(PhiR,PhiS,DofsLocalDirection);
    
    N = [NodalModes EdgeModes FaceModes];
