...
classdef HookePlaneStress < AbsMaterial
    
    methods (Access = public)
        function obj = HookePlaneStress(E,Poisson,Density,ScalingFactor)
            obj.MaterialMatrix = zeros(3,3);
            obj.MaterialMatrix(1,1) = 1;
            obj.MaterialMatrix(2,2) = 1;
            obj.MaterialMatrix(3,3) = (1-Poisson)/2;
            obj.MaterialMatrix(1,2) = Poisson;
            obj.MaterialMatrix(2,1) = Poisson;
            obj.MaterialMatrix = (E/(1-Poisson^2))* obj.MaterialMatrix;
            obj.Density = Density;
